      ...
      <form action="" method="post" id="pesan">
        ...
        <table>
          ...
          <tr>
            ...
            <td><?php echo $id_barang . " - " . $namaProdukView ?></td>

          </tr>

          <tr>
            <td class="left">Catatan</td>
            <td><textarea style="padding-left:5px; padding-top:5px;" rows="2" cols="50" form="pesan" name="catatan" value="<?php echo $catatan ?>"></textarea></td>
