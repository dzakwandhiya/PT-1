...
<body>
    ...
    <div class="mx-auto">
        <div class="card shadow-lg p-3 mb-5 bg-white rounded">
            <h1 class="card-header text-white bg-success"><b>DATA PEMESANAN</b></h1>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT id_pesanan, tgl_pesanan, pembayaran, catatan, status_pembayaran, status_pengiriman, status_penerimaan, id_produk, email FROM pesanan"; //"SELECT*FROM pesanan ORDER BY id_pesanan DESC";
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <th scope='row' class='ctt'>" . $catatan . "</th>
                                <form action='' method='post' id='update'>
                                <th scope='row' class='align-middle'>" . $status_pembayaran . "</th>
                                <th scope='row' class='align-middle'>" . $status_pengiriman . "</th>
                                <th scope='row' class='align-middle'>" . $status_penerimaan . "</th>
                                </form>
                                ...
                                <a href='update-pesanan.php?id=$id_pesanan'><button type='submit' name='upd' class='btn btn-success'>Edit</button></a><br>
