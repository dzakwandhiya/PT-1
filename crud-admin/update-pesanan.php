        ...
        <div class="card shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table">
                        <!--<thead>
                            <tr>
                                ...
                                <!--<th scope="col">Stt_Pembayaran</th>
                                <th scope="col">Stt_Pengiriman</th>
                                <th scope="col">Stt_Penerimaan</th>
                            ...
                            ?>
                             ...
                             <!--<tr>
                                <form action="" method="post" id="update">
                                    ...
                                    <th scope='row'></th>
                                    <th scope='row'></th>
                                    <th scope='row' class='ctt'></th>
                                    
                                       <th scope='row'>
                                            <textarea rows="2" placeholder="" form="update" name="stt_pembayaran" value="<?php //echo $newStatus_pembayaran?><select>                                                                                    ?>"><?php //echo $status_pembayaran ?></textarea>-->
                                        <!--<select name="stt_pembayaran" id="stt_pembayaran">
                                            <option value="<?php // echo $status_pembayaran?>" <?php //if($newStatus_pembayaran == $status_pembayaran) echo "selected"?>>- Update Status -</option>
                                        ...
                                        <th scope='row'><!--<textarea rows="2" placeholder="" form="update" name="stt_pengiriman" value="<?php //echo $newStatus_pengiriman ?>"><?php //echo $status_pengiriman ?></textarea>
                                        <select name="stt_pengiriman" id="stt_pengiriman">
                                            <option style="text-align:center;" value="<?php //echo $status_pengiriman?>" <?php //if($newStatus_pengiriman == $status_pengiriman) echo "selected"?>>- Update Status -</option>
                                        ...
                                        <th scope='row'><!--<textarea rows="2" placeholder="" form="update" name="stt_penerimaan" value="<//?php echo $newStatus_penerimaan ?>"><//?php echo $status_penerimaan ?></textarea>
                                        <select name="stt_penerimaan" id="stt_penerimaan">
                                            <option value="<?php //echo $status_penerimaan?>" <?php //if($newStatus_penerimaan == $status_penerimaan) echo "selected"?>>- Update Status -</option>
                                        ...
                                        <th scope='row'><?php echo $email_agen ?></th>
                    ...
                    <a href='crud-admin.php?op=edit&id=$id_pesanan' onclick="return confirm('Update Status Pesanan ?')"><button type='submit' form='update' name='update' class='btn btn-success'>Update</button></a><br>
