                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <a href='crud-admin.php?op=edit&id=$id_pesanan' onclick="return confirm('Update Informasi Produk ?')"><button type='submit' form='update' name='update' class='btn btn-success'>Update</button></a><br>
